<template>
    <div class="flex flex-col md:flex-row gap-6 mb-8 w-full items-start">
        <div id="input"
            ...
            <div class="space-y-8">
                <div>
                    <label class="block text-sm font-bold text-emerald-600 dark:text-emerald-400 mb-4 ml-1">Posisi Benar
                        (Hijau)</label>
                ...
                <div>
                    <label class="block text-sm font-bold text-amber-600 dark:text-amber-400 mb-3 ml-1">Ada, Tapi Posisi
                        Salah (Kuning)</label>
